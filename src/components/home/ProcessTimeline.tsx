...
const PHASES = [
  {
    ...
    title: "MAP",
    description:
      "System blueprint before a single line of code. Discovery, architecture, and every workflow mapped before touching the interface.",
  },
  {
    id: "design",
    number: "02",
    ...
    title: "DESIGN",
    description:
      "Every screen designed with intent. Interface, identity, and experience as one unified system.",
  },
  {
    id: "build",
    number: "03",
    ...
    title: "BUILD",
    description:
      "Full-stack sprint-based engineering and QA. Front to back, integrated and deployed. Production-ready, not demo-ready.",
  },
  {
    id: "operate",
    number: "04",
    ...
    title: "OPERATE",
    description:
      "Ongoing deployment, monitoring, and iteration. A partnership, not a handoff. We stay in the system after it ships.",
  },
] as const;
  ...
  return (
    <section className="section process-timeline-section">
      <div className="container">
        <div className="process-timeline" aria-label="COREFRAME process">
          ...
          <div className="process-timeline__detail process-timeline__detail--home">
